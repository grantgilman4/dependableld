...
const About = () => {
  ...
  <div className="flex justify-center items-center bg-white shadow-lg max-sm:flex-col max-sm:h-screen max-sm:pb-20">
    ...
    <div className="font-semibold bg-orange-600 rounded-xl p-5 w-[400px] text-white">
